...
public class Boss4 : MonoBehaviour
{
    ...
    public static bool boss4Destroyed;
    bool moveRight;
    BoxCollider2D box;
    ...
    void Start()
    {
        ...
        InvokeRepeating("FireBalls", 3f, 3f);
    }
    ...
    {
        Instantiate(fireBall, transform.position + new Vector3(1.2f, 0, 0), Quaternion.identity);
        Instantiate(fireBall, transform.position + new Vector3(0.8f, 0, 0), Quaternion.identity);
        Instantiate(fireBall, transform.position + new Vector3(0.4f, 0, 0), Quaternion.identity);
        Instantiate(fireBall, transform.position + new Vector3(0.0f, 0, 0), Quaternion.identity);
        Instantiate(fireBall, transform.position + new Vector3(-0.4f, 0, 0), Quaternion.identity);
        Instantiate(fireBall, transform.position + new Vector3(-0.8f, 0, 0), Quaternion.identity);
        Instantiate(fireBall, transform.position + new Vector3(-1.2f, 0, 0), Quaternion.identity);
    }
